	...
	<div class="x-body">
		...
		${tip_info }
			<ul class="toolbar">
				...
				<li
					onclick="user_management_add('添加选项','add_page','600','500')"><span><img
		...
		<table class="tablelist">
			...
			<tbody>
				<c:forEach items="${option_list}" var="option" varStatus="i">
					<tr>
						...
						<td class="td-manage"><a title="编辑" href="#"
							onclick="user_management_add('添加选项','update_page?id=${option.id}','600','500')"
		...
		<div class="turnPage center fr">
			<span style="margin-right: 20px;">共${pageInfo.total}条记录,当前第${pageInfo.pageNum }页,共${pageInfo.pages}页
			</span> <a href="findByPage?pageNum=1">首页</a>
