...
<body>
	...
	${tip_info }
        ...
        <li onclick="user_management_add('添加专业信息','addPage','600','500')"><span><img src="${pageContext.request.contextPath}/images/t01.png" /></span>添加</li>
      </ul>  
   </div>
            <table class="tablelist">
                ...
                <tbody>
                	<c:forEach items="${major_list}" var="major" varStatus="i">
                    <tr>
                     ...
                     <td class="td-manage">
                        <a title="编辑" href="#" onclick="user_management_add('修改专业信息','updatePage?id=${major.id}','600','500')"
