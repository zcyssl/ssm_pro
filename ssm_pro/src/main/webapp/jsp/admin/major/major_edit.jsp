...
<head>
	...
	function modify() {
	  var major_name=document.getElementById("majorName").value;
		 ...
		 <input type="hidden" name="id" value="${major_info.id}"/>
            <div class="layui-form-item">
                 <label class="layui-form-label">专业名称</label>
                    <div class="layui-input-inline">
                        <input type="text" name="majorName" id="majorName" value="${major_info.majorName}" class="layui-input">
                    </div>
            ...
            <div class="layui-form-item">
                 <label for="L_username" class="layui-form-label">
                    ...
                    <select name="academyInfoId">
                    <c:forEach items="${academy_list}" var="academy">
                    <option value="${academy.id}"
                    <c:if test="${academy.id eq major_info.academyInfo.id }"> selected="selected" </c:if>
