...
<script type="text/javascript">
	...
	function deleteByIds(){
		if (window.confirm("确认删除吗?")){
			...
			var ids = document.getElementsByName("classinfoIds");
...
<body>
	...
	<div class="x-body">
		<div class="tools">
			${tip_info }
			<ul class="toolbar">
				<li onclick="deleteByIds()" ><span><img
						src="${pageContext.request.contextPath}/images/t03.png" /></span>批量删除</li>
				<li
					onclick="user_management_add('添加班级信息','addPage','600','500')"><span><img
		...
		<table class="tablelist">
			...
			<tbody>
				<c:forEach items="${class_list}" var="classinfo" varStatus="i">
					<tr>
						<td class="td-manage"><input type="checkbox" name="classinfoIds" value="${classinfo.id}"> ${i.count}</td>
						...
						<td class="td-manage"><a title="编辑" href="#"
							onclick="user_management_add('修改班级信息','updatePage?id=${classinfo.id}','600','500')"
