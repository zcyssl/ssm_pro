...
<head>
   ...
   function modify() {
	  var student_num=document.getElementById("studentNum").value;
	  var student_pass=document.getElementById("studentPassword").value;
...
<body>
	<div class="x-body">
    <form action="updateSave" id="modifyform" method="post">
        ...
        <div class="layui-form-item">
        	<label class="layui-form-label"><span class="x-red">*</span>学号</label>
            	<div class="layui-input-inline">
                	<input type="text" name="studentNum" id="studentNum" value="${student_info.studentNum}" class="layui-input">
                </div>
                    <div class="layui-form-mid layui-word-aux"></div></div>
        <div class="layui-form-item">
        	<label class="layui-form-label"><span class="x-red">*</span>姓名</label>
            	<div class="layui-input-inline">
                	<input type="text" name="studentName" id="studentName" value="${student_info.studentName}" class="layui-input">
               </div></div>
        <div class="layui-form-item">
        	<label class="layui-form-label"><span class="x-red">*</span>手机号</label>
            	<div class="layui-input-inline">
                	<input type="text" id="studentPhone" name="studentPhone" id="student_phone" value="${student_info.studentPhone}" class="layui-input">
               </div></div>
        <div class="layui-form-item">
        	<label class="layui-form-label"><span class="x-red">*</span>性别</label>
            	<div class="layui-inline">
                	<div class="layui-input-inline" >
                     <input type="radio" name="studentGender" value="0"
                	 <c:if test="${student_info.studentGender eq 0}">checked="checked"</c:if>
                	 />&nbsp;男 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                	  <input type="radio" name="studentGender" value="1"
        ...
        <div class="layui-form-item">
            ...
            <span class="x-red">*</span>专业</label>
                <div class="layui-input-inline">
                    <select name="majorInfoId" >
                    <c:forEach items="${major_list}" var="major">
                    <option value="${major.id}" 
                    <c:if test="${major.id eq student_info.majorInfo.id}">
                    selected="selected"
                    </c:if>
