					...
					<form action="answer.do" method="post">
						...
						<div class="test_content">
							<div class="test_content_title">
								<h2>单选题</h2>
								<p>
									<span>共</span><i class="content_lit">100</i><span>题，</span><span>合计</span><i
						...
						<div class="test_content_nr">
							<ul>
							<c:forEach items="${question_list}" var="paper" varStatus="i">
								<li id="qu_0_0">
								...
								<div class="test_content_nr_main">
									<ul>
										...
										class="radioOrCheck" name="answer_${paper.questionNum}" id="0_answer_1_option_1" value="${paper.optionInfo.optionType}"/>
											<label for="0_answer_1_option_1"> ${paper.optionInfo.optionType }.
													<p class="ue" style="display: inline;">${paper.optionInfo.optionContent}</p>
											</label>
										</li>
									<%-- <c:if test="${(i.index mod 4 eq 0) and i.index eq (bb)}"> --%>
									</ul>
								</div>
							</li>
								<%-- </c:if> --%>
									<c:set var="bb" value="${i.index }"></c:set>
						</c:forEach>
					...
					<div class="rt_nr1">
						...
						<div class="rt_content">
							<div class="rt_content_tt">
								<h2>单选题</h2>
								<p>
									<span>共</span><i class="content_lit">100</i><span>题</span>
								</p>
							</div>
