   	...
   	<div class="layui-form-item">
        ...
        <div class="layui-form-item">
         ...
         <div class="layui-form-item">
			...
			<div class="layui-input-inline layui-input">
			${student_info.academyInfo.academyName}
			</div>
		</div>
			<div class="layui-form-item">
				<label for="link" class="layui-form-label">专业</label>
				<div class="layui-input-inline layui-input">
					${student_info.majorInfo.majorName}</div>
			</div>
			<div class="layui-form-item">
         ...
         <div class="layui-form-item">
         	<label for="link" class="layui-form-label">联系电话</label>
            	<div class="layui-input-inline">
                	<input type="text" id="link" name="studentPhone" class="layui-input"
        ...
        <div style="color:red;font-size:20px ">${tip_info}</div>
